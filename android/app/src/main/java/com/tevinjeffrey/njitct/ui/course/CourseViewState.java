...
import com.tevinjeffrey.njitct.ui.base.View.LayoutType;
...
public class CourseViewState extends BaseViewState<CourseView> implements Parcelable {
    ...
    public List<? extends CourseModel> data = new ArrayList<>(10);
    ...
    protected CourseViewState(Parcel in) {
        ...
        this.data = in.createTypedArrayList(NCourse.CREATOR);
        this.isRefreshing = in.readByte() != 0;
        this.errorMessage = in.readString();
    }

    public static final Parcelable.Creator<CourseViewState> CREATOR = new Parcelable.Creator<CourseViewState>() {
